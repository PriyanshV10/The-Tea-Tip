...
const About = () => {
    return (
        <div className="text-white container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4 text-center">About The Tea Tip</h1>
            <p className="text-lg mb-6">
                The Tea Tip is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you a Tea. Unlock the potential of your fanbase and bring your projects to life.
            </p>

            <h2 className="text-2xl font-semibold mb-4">How It Works</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <Image className=" rounded-full mr-4" width={80} height={80} src="/group.gif" alt="Fans Want to Collaborate" />
                    <div>
                ...
                <div className="flex items-center mb-6">
                    <Image className="rounded-full mr-4" width={80} height={80} src="/coin.gif" alt="Support Through Tea" />
                    <div>
            ...
            <h2 className="text-center text-2xl font-semibold my-12">Benefits for Creators and Fans</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div>
                ...
                <div>
                    <h3 className="text-xl font-semibold mb-4">Fans</h3>
                    <ul className="list-disc pl-6 mb-6">
